...
export function About(props: AboutProps) {
  ...
  return (
    <article className="h-full min-h-0 max-h-full overflow-y-auto pr-4 [scrollbar-gutter:stable] text-[0.9625rem] leading-relaxed text-white max-[1366px]:text-[0.875rem]">
