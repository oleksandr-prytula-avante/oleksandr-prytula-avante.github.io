...
const EN_TRANSLATIONS: Translations = {
  ...
  [ETranslationKey.AboutParagraph2]:
    "As a Full-Stack WEB Developer, I deliver solutions from Front-End interfaces to Back-End services and infrastructure. I’m experienced with monolithic and microservice architectures, REST / GraphQL APIs, databases like SQL (MySQL, SQLite and PostrgeSQL) and MongoDB. I actively use Docker and implement CI / CD pipelines for automated deployment. Additionally, I use testing frameworks such as Playwright and Jest to ensure high code quality and reliability.",
...
const SP_TRANSLATIONS: Translations = {
  ...
  [ETranslationKey.AboutParagraph2]:
    "Como desarrollador Full-Stack WEB, entrego soluciones desde interfaces Front-End hasta servicios Back-End e infraestructura. Tengo experiencia con arquitecturas monolíticas y de microservicios, APIs REST/GraphQL y bases de datos como SQL (MySQL, SQLite y PostrgeSQL) y MongoDB. Utilizo activamente Docker e implemento pipelines de CI / CD para despliegues automatizados. Además, uso frameworks de testing como Playwright y Jest para garantizar alta calidad y fiabilidad del código.",
  [ETranslationKey.AboutParagraph3]:
